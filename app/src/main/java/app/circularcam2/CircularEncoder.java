...
public class CircularEncoder {
     ...
     */
    public CircularEncoder(int width, int height, int bitRate, int frameRate, int desiredSpanSec, Callback cb) {
        ...
        mDesiredSpanSec = desiredSpanSec;
        mCallBack = cb;
    ...
    public void prepareEncoder(){
        ...
        CircularEncoderBuffer encBuffer = new CircularEncoderBuffer(mBitRate, mFrameRate, mDesiredSpanSec);
        ...
        // we've initialized.
        mEncoderThread = new EncoderThread(mEncoder, encBuffer, mCallBack);
